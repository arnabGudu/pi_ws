...
if(NOT "/home/iarc/pi_ws/devel/.private/gazebo_ipbot/include " STREQUAL " ")
  set(gazebo_ipbot_INCLUDE_DIRS "")
  set(_include_dirs "/home/iarc/pi_ws/devel/.private/gazebo_ipbot/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ipbot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iarc/pi_ws/src/gazebo_ipbot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iarc/pi_ws/devel/.private/gazebo_ipbot/lib;/home/iarc/pi_ws/devel/lib;/opt/ros/kinetic/lib)
